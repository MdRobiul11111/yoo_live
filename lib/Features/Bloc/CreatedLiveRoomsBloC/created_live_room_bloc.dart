...
class CreatedLiveRoomBloc extends Bloc<CreatedLiveRoomEvent, CreatedLiveRoomState> {
  ...
  CreatedLiveRoomBloc(this.authDataRepository,this.socketService,this.sharedPreferences)
  ...
  Future<void> _onConnectSocket(ConnectSocketEvent event, Emitter<CreatedLiveRoomState> emit) async{
    try {
  ...
  Future<void> _onSetupSocket(SetupSocket event, Emitter<CreatedLiveRoomState> emit) async{
  ...
  Future<void> _onJoinRoomEvent(JoinSocketRoomEvent event, Emitter<CreatedLiveRoomState> emit) async{
    try {
