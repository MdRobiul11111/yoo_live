...
import 'package:yoo_live/widget/presentation/profile/edit_profile.dart';
import 'package:yoo_live/widget/presentation/profile/followers_widget/followers_page.dart';
        ...
        builder: (context, state) {
          if (state is AuthProfileStateLoading) {
            ...
            final List<Widget> allGridItems = [
              ...
              _gridItem("assets/icon/Frame 2147228116 (6).png", "Admin"),
            ];
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Text(
                      "ID: ${state.authProfile.data?.userId} | ${state.authProfile.data?.country}",
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: _countColumn("0", "Followers"),
                        ),
                        // FollowingPage
                        InkWell(
                          onTap: () {
                          ...
                          child: _countColumn("0", "Following"),
                        ),
                      ],
                    ),
                        ...
                        InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => CustomCategoryTabs(),
                              ),
                            );
                          },
                          child: Container(
