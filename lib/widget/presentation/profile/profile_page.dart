          ...
          child: Column(
            children: [
              ...
              CircleAvatar(
                ...
                ), // Replace with NetworkImage if online
              ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Spacer(),
                        Image(image: AssetImage("assets/icon/coin 1.png")),
                        SizedBox(width: 10),
                        Text(
                          "100",
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Spacer(),
                        Image(image: AssetImage("assets/icon/diamond 1.png")),
                        SizedBox(width: 10),
                        Text(
                          "100",
                          style: TextStyle(fontSize: 20, color: Colors.white),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Spacer(),
                        Image(
                          image: AssetImage("assets/icon/Simplification.png"),
                        ),
                        SizedBox(width: 10),
                        Text(
                          "VIP",
